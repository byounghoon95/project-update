...
<body>
   <div class="container mypage_all">
      ...
      <div class="profile_box">
         <div class="left_prf">
            <img src="${pageContext.request.contextPath}/images/adm_profile.jpg" class="profile_img" alt="..."><p>
         </div>
         <div class="right_prf">
            <span class="prf_name">치커리</span>
            <img src="${pageContext.request.contextPath}/images/cheese.png" class="cheese_img" alt="..."><br>
