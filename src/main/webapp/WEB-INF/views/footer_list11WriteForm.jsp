...
<body>
	...
	<form action="footer_list11Write">
	<input type="hidden" name="memberId" value="${id }">
	<div class="wrap">
		<h4>
			<i class="fa-solid fa-clipboard"></i>&nbsp문의등록
		</h4>
		<hr />
			<h6>제목</h6>
			<input type="text" id="title_input" name="inqtitle" placeholder="제목을 입력해주세요" />
			<hr />
			<h6>내용</h6>
			<textarea class="mb-4" rows="25" cols="100" placeholder="내용을 입력해주세요"
				id="content_input" name="inqcontent"></textarea>
			<div id="reg_btn" class="d-flex justify-content-center">
				...
				<button type="submit" class="btn btn-blue mx-1">문의하기</button>
			</div>
	</div>
	</form>
	<div id="blank"></div>
