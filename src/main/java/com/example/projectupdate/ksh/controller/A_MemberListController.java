...
//	public String list(MemberEntity member, String currentPage, Model model) {
...
//		List<MemberEntity> listMember = ms.listMember(member);
...
//		MemberEntity member = ms.detail(id);
//
...
//	  public String update(MemberEntity member, Model model){
...
//		  public String delete(MemberEntity member, Model model) {
...
//	 public String A_Mkeyword(MemberEntity member, String currentPage, Model model) {
...
//			member.setStart(pg.getStart());
//			member.setEnd(pg.getEnd());
//			List<MemberEntity> A_Mkeyword = ms.A_Mkeyword(member);
